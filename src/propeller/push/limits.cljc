...
(def "Used to ensure that strings don't get too large." max-string-length 1000)

;; Used to ensure that vectors don't get too large
(def "Used to ensure that vectors don't get too large." max-vector-length 1000)

;; Used to ensure that total
;; Set as dynamic for testing purposes.
(def "Used to ensure that total code points don't get too large. Set as dynamic for testing purposes." ^:dynamic max-code-points 100)

;; Used to ensure that the depth of nesting for Push expressions doesn't get too deep.
;; Set as dynamic for testing purposes.
(def "Used to ensure that the depth of nesting for Push expressions doesn't get too deep. Set as dynamic for testing purposes." ^:dynamic max-code-depth 200)
